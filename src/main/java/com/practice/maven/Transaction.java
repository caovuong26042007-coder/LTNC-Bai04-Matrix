...
public class Transaction {
     ...
     * @return
     */
    public static String getTypeString(int transaction) {
        switch (transaction) {
    ...
    /**
     * Lấy chuỗi tóm tắt thông tin chi tiết của giao dịch.
     *
     * @return Chuỗi định dạng chứa loại giao dịch, số dư đầu, số tiền và số dư
     * cuối.
     */
    public String getTransactionSummary() {
        ...
        String pattern = "- Kiểu giao dịch: %s. Số dư ban đầu: $%.2f. Số tiền: $%.2f. Số dư cuối: $%.2f.";
        return String.format(Locale.US, pattern,
                getTypeString(type),
                initialBalance,
                amount,
                finalBalance);
